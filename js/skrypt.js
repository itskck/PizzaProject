...
function zamawiam() {
  if(localStorage.getItem("dostawa")==null)
  {
    alert("Dane nie zostały wprowadzone i zapisane")
    return;
  }
  if(koszyk.length==0)
  {
  ...
  sessionStorage.removeItem('koszyk');
  koszyk=[];
  koszykDiv.innerHTML="";
  document.getElementById('koszyk-koszt').innerHTML = 'Razem: 0 zł';
}
